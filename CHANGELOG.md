...
- Ported Chronicle 1.3.1 to Minecraft 1.21.11
- Updated Fabric API, Text Placeholder API, and Mod Menu compatibility for the 1.21.11 release line
- Set the minimum Fabric Loader version to 0.17.3
