...
- Ported Chronicle 1.3.1 to Minecraft 1.20.1
- Updated Fabric API, Text Placeholder API, and Mod Menu compatibility for the 1.20.1 release line
- Set the minimum Fabric Loader version to 0.14.21
...
- Ported Chronicle 1.3.1 to Minecraft 1.20.2
- Updated Fabric API, Text Placeholder API, and Mod Menu compatibility for the 1.20.2 release line
- Set the minimum Fabric Loader version to 0.14.22

## 1.3.1+1.20.3

### Changed

- Ported Chronicle 1.3.1 to Minecraft 1.20.3
- Updated Fabric API and Text Placeholder API compatibility for the 1.20.3 release line
- Set the minimum Fabric Loader version to 0.14.23
...
- Ported Chronicle 1.3.1 to Minecraft 1.20.5
- Updated Fabric API compatibility for the 1.20.5 release line
- Set the minimum Fabric Loader version to 0.15.6

## 1.3.1+1.20.6

### Changed

- Ported Chronicle 1.3.1 to Minecraft 1.20.6
- Updated Fabric API, Text Placeholder API, and Mod Menu compatibility for the 1.20.6 release line
- Set the minimum Fabric Loader version to 0.15.6
