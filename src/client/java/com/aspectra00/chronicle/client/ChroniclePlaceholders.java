...
/** Resolves friendly Chronicle aliases and every placeholder registered with Text Placeholder API. */
public final class ChroniclePlaceholders {
    ...
    public static String resolve(String input) {
        ...
        try {
            ...
            // A placeholder supplied by another mod can disappear between worlds or reloads.
            // Keep the reminder usable instead of losing the whole notification.
            return expanded;
        }
    }
